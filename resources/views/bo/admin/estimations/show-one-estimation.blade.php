        ...
        <div class="mout-admin-container">
            ...
            <div class="mout-admin-right-panel">
                ...
                <div id="estimation-action-2">
                    <a href="{{route('createPDFEstimation', $estimation->id)}}" target="_blank" class="btn mout-btn-other">
                        <span class="btn-label"><i class="fal fa-chevron-right"></i></span>Voir le pdf</a>
                    <a href="{{route('editEstimation', $estimation->id)}}" class="btn btn-labeled mout-btn-edit">
                        <span class="btn-label"><i class="fal fa-chevron-right"></i></span>Modifier
                    </a>
                </div>
                <div id="estimation-action-3" @if($estimation->validation === 1) class="estimation-action-active" @endif>
                    <a href="{{route('createDownPaiementInvoice', $estimation->id)}}" class="btn mout-btn-pdf">
                        <span class="btn-label"><i class="fal fa-chevron-right"></i></span>Créer une facture d'acompte
                    </a>
                    <a href="{{route('createInvoice', $estimation->id)}}" class="btn btn-mout mout-btn-add">
                        <span class="btn-label"><i class="fal fa-chevron-right"></i></span>Créer la facture
                    </a>
                </div>
