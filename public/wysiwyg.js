(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["wysiwyg"],{

/***/ "./resources/js/vendors/wysiwyg/content-tools.js":
/*!*******************************************************!*\
  !*** ./resources/js/vendors/wysiwyg/content-tools.js ***!
  \*******************************************************/
...
(function () {
  ...
  HTMLString.String = function () {
    ...
    String.prototype.optimize = function () {
      ...
      runLengthSort = function runLengthSort(a, b) {
        return b[1] - a[1];
      };
...
(function () {
  ...
  _containedBy = function _containedBy(nodeA, nodeB) {
    while (nodeA) {
      if (nodeA === nodeB) {
        return true;
      }
  ...
  _getChildNodeAndOffset = function _getChildNodeAndOffset(parentNode, parentOffset) {
  ...
  _getOffsetOfChildNode = function _getOffsetOfChildNode(parentNode, childNode) {
  ...
  _getNodeRange = function _getNodeRange(element, docRange) {
...
(function () {
  ...
  ContentEdit = {
    ...
    addTranslations: function addTranslations(language, translations) {
      return ContentEdit._translations[language] = translations;
    },
    addCSSClass: function addCSSClass(domElement, className) {
    ...
    attributesToString: function attributesToString(attributes) {
  ...
  ContentEdit.Text = function (_super) {
    ...
    Text.mergers = {
      'Text': function Text(element, target) {
        var offset;
  ...
  ContentEdit.ListItemText = function (_super) {
    ...
    ListItemText.droppers = {
      'ListItemText': function ListItemText(element, target, placement) {
      ...
      'Text': function Text(element, target, placement) {
    ...
    ListItemText.mergers = {
      'ListItemText': function ListItemText(element, target) {
        var offset;
        offset = target.content.length();
...
(function () {
  ...
  ContentTools = {
    ...
    getEmbedVideoURL: function getEmbedVideoURL(url) {
    ...
    getHTMLCleaner: function getHTMLCleaner() {
      return new ContentTools.HTMLCleaner();
    },
    getRestrictedAtributes: function getRestrictedAtributes(tagName) {
      var restricted;
      restricted = [];
    ...
    ToolboxUI.prototype._addDOMEventListeners = function () {
      ...
      this._handleResize = function (_this) {
        return function (ev) {
          ...
          containResize = function containResize() {
  ...
  ContentTools.TableDialog = function (_super) {
    ...
    TableDialog.prototype._addDOMEventListeners = function () {
      ...
      toggleSection = function toggleSection(ev) {
        ev.preventDefault();
      ...
      watch = function (_this) {
        return function () {
          ...
          if (lastModified > _this._lastSnapshotTaken) {
            ...
            delayedStore = function delayedStore() {
